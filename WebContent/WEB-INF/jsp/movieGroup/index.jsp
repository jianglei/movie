    	...
    	<div class="news_top">
            ...
            <div class="tab tabw1">
                ...
                <c:forEach items="${dianying.result}" var="movie" varStatus="status">
                  <li>
                      <a href="/movieGroup/movieDetail?id=${movie.id }" class="i"><img src="${movie.pic_url }" alt="${movie.name }"><!--  <em class="v">1280高清</em>--></a>
                      <p><b class="c0071bc"><a href="/movieGroup/movieDetail?id=${movie.id }">${fn:substring(movie.name, 0, 7)}</a></b></p>
                ...
                <ul class="pic plist1" id="con_ph_2" style="display: none;"> 
                  ...
                  <li>
                      <a href="/movieGroup/movieDetail?id=${movie.id }" class="i"><img src="${movie.pic_url }" alt="${movie.name }"></a>
                      <p><b class="c0071bc"><a href="/movieGroup/movieDetail?id=${movie.id }">${fn:substring(movie.name, 0, 7)}</a></b></p>
                      <em>${fn:substring(movie.last_update_time, 0, 4)}-${movie.category}</em>
                  </li>
          		</c:forEach>
