                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb_form" style="border-collapse:separate;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- <a class="ui_radio ui_radio_entrance"  ><span adSlotLandingType="bigimage" class='bigimage'>大图</span></a><br /> -->
                ...
                <div class="msg_content_center">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb_form">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="ui_radio ui_radio_wapTemplate" tpType="applist"  ><span class="">模板一</span></a> 
                                <a class="ui_radio ui_radio_wapTemplate" tpType="horizon_bigimage"  ><span class="">模板二</span></a>  
