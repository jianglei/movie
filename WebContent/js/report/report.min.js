...
if(a.param.name=="list"){$("div.sel_wrap,div.sel_title").hide();}if(a.param.name=="ad"){$(".output_csv").show();}if(b[a.param.name]){$("div.sel_title1").text(b[a.param.name]);
...
a.currentToken=a.getToken();a.getPostData();a.loadData($(this).find("a").attr("id"),a.param.data);});if(!!~$.inArray(a.param.name,["app","adslot","list"])){$("div.sel_wrap2,div.sel_title2").show();
