...
//			$(this).children('.pop_menu').slideToggle();
//		}
	})
...
function doDirection(param){
	...
	if(adgroupId=="0"){
		window.location="/advertiser/adgroup/"+campaignId+"/index?"+param;
		return;
	}
	window.location="/advertiser/creative/"+adgroupId+"/index?"+param;
}
