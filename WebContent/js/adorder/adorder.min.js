...
}});loadList(1);});});});function loadList(b,a){$.ajax({type:"get",url:"adorder/list?pageNo="+b+(a?a:""),dataType:"json",data:"rnd="+Math.random(),beforeSend:function(c){},success:function(g,d){var k=g.adOrderPage;
