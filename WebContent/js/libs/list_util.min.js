...
}function adjustMsg(){var a=$(window).height()/2-($(".blockMsg .msgForm").height()/2);a=a<0?0:a;$(".blockMsg").css({top:a+"px"});}function popBox(d){var a=$(window).height(),b=$(document).width(),c=a/2-(d.height()/2);
c=c<0?0:c;$.blockUI({css:{overflow:"hidden",height:0,position:"relative",color:"#cccccc",border:"0",width:"722px",left:b/2-(d.width()/2),top:c,background:"none",padding:"0px"},overlayCSS:{backgroundColor:" rgba(0,0,0,.5)",opacity:1,overflow:"auto"},allowBodyStretch:true,message:d,onBlock:function(){$(".blockOverlay").append($(".blockMsg"));
