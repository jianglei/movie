...
},url:function(l){var k=/^(http:|https:|telephone:|sdk:)\/\//ig;console.log(k.test(l));if(k.test(l)&&$.trim(l.replace(k,""))===""){return{pass:false,msg:"请输入正确的url"};
}else{return{pass:true};}}};var h=g?g:f,i={pass:true},a=f.val();if(a.indexOf("<")>-1||a.indexOf(">")>-1||a.indexOf("script")>-1||a.indexOf("eval")>-1){i={pass:false,msg:"字符不符合规则"};
