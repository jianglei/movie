...
$("body").css({"overflow-y":"hidden"});$(".blockMsg").css({height:"auto",overflow:"auto"});}});}function set_date_param(b,a,c){$("#dateType").val(b);$("#startDate").val(a);
$("#endDate").val(c);}function checkAll(b,a){$("input[name="+a+"]").prop("checked",$(b).prop("checked"));}function checkAllAdSlot(b,a){if($(b).prop("checked")){if($("input[name="+a+"]:checked").length>0){$("input[name="+a+"]").not(":disabled").prop("checked",true);
