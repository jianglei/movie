...
var b=1,a=[{name:"正常",query:"normal"},{name:"应用暂停",query:"app_pause"},{name:"暂停",query:"pause"},{name:"到达预算",query:"limit"},{name:"订单暂停",query:"adorder_pause"},{name:"投放完成",query:"finish"},{name:"订单投放完成",query:"adorder_finish"},{name:"尚未投放",query:"ready"},{name:"订单尚未投放",query:"adorder_ready"},{name:"iOS",query:"iOS"},{name:"Android",query:"android"}],d="";
...
if($(this).siblings("label").hasClass("platform")){url_status+="&platform="+a[$(this).val()].query;}else{url_status+=("&status="+($(this).attr("pausetype")?($(this).attr("pausetype")+"_"):"")+a[$(this).val()].query);
}});if(b==1){d='<span class="none">未筛选</span>';url_status="";}$(this).closest(".state").find(".state_info").html(d);$(this).closest(".state").removeClass("show");
