...
},minLength:function(l,k){return l.length>=k?{pass:true}:{pass:false,msg:"长度不能小于 "+k};},fixLength:function(l,k){if($.type(k)=="number"){return l.length==k?{pass:true}:{pass:false,msg:"固定长度为 "+k};
