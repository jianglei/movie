...
$("body").css({"overflow-y":"auto"});}});$(".step1").hide();$(".step2").show();adjustMsg();$(".err").remove();$(".ui_radio_type").removeClass("ui_radio_checked");
$(".ui_radio_form").removeClass("ui_radio_checked");$("input[name='appname']").val("");$("input[name='adWords']").val("");$("input[name='provider']").val("");
$("input[name='weburl']").val("http://");$("input[name='webname']").val("");$("input[name='icon']").val("");$("input[name='url']").val("");$("input[name='weblogo']").val("");
$("input[name='bannerimg']").val("");$("textarea[name='description']").val("");$("input[type='file']").val("");$('input[name="textFont"]').val("");$(".ui_select_textFont span.text").text("请选择字体");
$('input[name="textSize"]').val(d.textSizeAdSlot!==""?d.textSizeAdSlot:"");$(".ui_select_textSize span.text").text(d.textSizeAdSlot!==""?d.textSizeAdSlot:"请选择字体大小");
$('input[name="textColor"]').val("#000000").css("background","#000000");$("#icon_show").attr("src","");$("#name_show").text("");$("#des_show").text("");
$("#bannerimg_show").attr("src","");$(".ui_radio_form,.ui_radio_type").removeClass("ui_radio_checked ui_radio_disabled");$("#bannerOrBigImg").text("横幅图片");
if(f.adContent){d.landingSize=f.adContent.landingSize||d.landingSize;d.platform=f.adContent.platform||d.platform;}$("#adLandingSize").val(d.landingSize);
...
}}else{var a=d[c.platform][c.entryType].size;$(".ui_select_landingSize span.text").text(a).attr("title",a);$("#adLandingSize").val(a);}c.initStep2();adjustMsg();
...
$("body").css({"overflow-y":"auto"});}});});$(".btn_use_pastad").unbind("click").click(function(){k=f.getAD1();var l="";if(k!==null){$.ajax({type:"get",url:"/ad/add2",data:{platform:f.platform,landingSize:f.landingSize},dataType:"json",beforeSend:function(m){var n=$("#adListForUseContainer");
...
}else{alert("保存失败!");}},complete:function(n,o){},error:function(){alert("保存失败!");$(".btn_save_ad").unbind("click").click(function(){a.apply(this);});}});
}}$(".btn_save_ad").unbind("click").click(function(){a.apply(this);});},changeAdPreviewSize:function(c){var b=this,a={android:{width:"202",height:"55"},iOS:{width:"320",height:"50"}};
