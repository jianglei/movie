...
});$(window).resize(function(){a.adjustMsg();});},AD1:function(q,c,b,r,p,d,a,s,m,l,g,n,j,f,k){this.adOrderId=q;this.name=c;this.budget=b;this.budgetLimit=r;
if(p!=""){this.priceType=p;this.costPrice=d;}this.fixedRank=k;this.areas=a;this.networks=s;this.channels=m;this.adSlotId=l;this.startTime=g;this.landingSize=j;
this.platform=f;try{if($.trim(n.toString())!="00:00:00"){this.endTime=n;}}catch(o){var h=formatdate(new Date(n),"yyyy-MM-dd HH:mm");if($.trim(h)!="00:00:00"){this.endTime=n;
...
}if(d.fixedRank){$("#fixedRank").val(d.fixedRank);}else{$("#fixedRank").val("");}},initMsgAd2:function(f){var d=this;$(".msg_ad").unblock({onUnblock:function(){d.adSlotExistDialogId="";
}});$(".step1").hide();$(".step2").show();d.adjustMsg();$(".err").remove();$(".ui_radio_type").removeClass("ui_radio_checked");$(".ui_radio_form").removeClass("ui_radio_checked");
