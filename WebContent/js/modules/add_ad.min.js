...
if(f.entryType=="push"&&b=="4"){a=[true,false];c=[false,false,true];}else{a=g[f.entryType].adType;c=g[f.entryType].adStyle;}$(".ui_radio_form").each(function(k,l){if(!c[k]){$(l).addClass("ui_radio_disabled");
