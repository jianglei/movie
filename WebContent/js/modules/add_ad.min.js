...
}(function(){var g=e.adSlotPage.length;if(g>0){var h={bigimage:"轮播大图",embed:"内嵌入口",banner:"横幅",custom:"自定义入口",wap:"WAP",push:"推送",text:"文字链"};$(".tb_inner_wrap th input").prop("checked",false);
...
},changeFormStyle:function(){var c=this,d={android:{banner:{size:"202x55"},wap:{size:{standard:"202x55",image:"424x380"}},embed:{size:"202x55"},push:{size:{standard:"202x55",image:"424x380"}},bigimage:{size:"800x250"},custom:{size:"202x55"},text:{size:"-"}},iOS:{banner:{size:"320x50"},wap:{size:{standard:"320x50",image:"480x320"}},embed:{size:"320x50"},push:{size:{standard:"320x50",image:"480x320"}},bigimage:{size:"640x320"},custom:{size:"320x50"},text:{size:"-"}}},b=$("input[name='displayType']").val();
if(c.entryType=="wap"||c.entryType=="push"){var a=d[c.platform][c.entryType].size[b];$(".ui_select_landingSize span.text").text(a).attr("title",a);$("#adLandingSize").val(a);
...
$(".preview").width(d/(1+(parseInt(d)>400)));$(".preview").height(e/(1+(parseInt(e)>200)));if(b.landingSize=="480x320"||b.landingSize=="424x380"||b.landingSize=="800x250"||b.landingSize=="640x320"){$("#bannerOrBigImg").text("大图图片");
...
}a.adSlotPage=f.adSlotPage.result;a.adOrderPage=f.adOrderPage.result;var g=new Array();for(i=0;i<f.adHolderList.length;i++){g.push(f.adHolderList[i].adSlotId);
}f.ad.adSlotId=g;a.showMsg(f.ad,function(){$.unblockUI({onUnblock:function(){a.adDialogId="";a.updateItem(d);}});},-1,"",b);},complete:function(f,g){},error:function(){}});
