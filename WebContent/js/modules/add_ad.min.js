...
}});$(".step1").hide();$(".step2").show();adjustMsg();$(".err").remove();$("input[name='appname']").val("");$("input[name='adWords']").val("");$("input[name='provider']").val("");
...
$('input[name="textSize"]').val(f.textSizeAdSlot!==""?f.textSizeAdSlot:"");$(".ui_select_textSize span.text").text(f.textSizeAdSlot!==""?f.textSizeAdSlot:"请选择字体大小");
...
if(e.adContent){f.landingSize=e.adContent.landingSize||f.landingSize;f.platform=e.adContent.platform||f.platform;}$("#adLandingSize").val(f.landingSize);
