...
},changeFormStyle:function(){var c=this,d={android:{banner:{size:"202x55"},wap:{standard:"202x55",image:{applist:"424x380",horizon_bigimage:"424x380",vertical_bigimage:"380x424"}},embed:{size:"202x55"},push:{standard:"202x55",image:{applist:"424x380",horizon_bigimage:"424x380",vertical_bigimage:"380x424"}},bigimage:{size:"800x250"},custom:{size:"202x55"},text:{size:"-"}},iOS:{banner:{size:"320x50"},wap:{standard:"320x50",image:{applist:"480x320",horizon_bigimage:"480x320",vertical_bigimage:"320x480"}},embed:{size:"320x50"},push:{standard:"320x50",image:{applist:"480x320",horizon_bigimage:"480x320",vertical_bigimage:"320x480"}},bigimage:{size:"640x320"},custom:{size:"320x50"},text:{size:"-"}}},b=$("input[name='displayType']").val();
if(c.entryType=="wap"||c.entryType=="push"){if(b=="image"){var a=d[c.platform][c.entryType][b][c.template];$(".ui_select_landingSize span.text").text(a).attr("title",a);
$("#adLandingSize").val(a);}else{var a=d[c.platform][c.entryType][b];$(".ui_select_landingSize span.text").text(a).attr("title",a);$("#adLandingSize").val(a);
...
}}$(".btn_save_ad").unbind("click").click(function(){a.apply(this);});},adjustMsg:function(){$("body>.blockMsg").css({top:$(window).height()/2-($(".msg_ad").height()/2)+"px"});
...
$(".preview").width(d/(1+(parseInt(d)>400||parseInt(e)>200)));$(".preview").height(e/(1+(parseInt(e)>200||parseInt(d)>400)));if($.inArray(b.landingSize,["480x320","424x380","800x250","640x320","380x424","320x480"])>-1){$("#bannerOrBigImg").text("大图图片");
