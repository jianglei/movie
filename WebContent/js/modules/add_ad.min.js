...
$("input[name='adWords']").val("");$("input[name='provider']").val("");$("input[name='weburl']").val("http://");$("input[name='webname']").val("");$("input[name='icon']").val("");
$("input[name='url']").val("");$("input[name='weblogo']").val("");$("input[name='bannerimg']").val("");$("textarea[name='description']").val("");$("input[type='file']").val("");
$('input[name="textFont"]').val("");$(".ui_select_textFont span.text").text("请选择字体");$('input[name="textSize"]').val(d.textSizeAdSlot!==""?d.textSizeAdSlot:"");
