...
var imageUrl = '/images/iColorPicker.jpg';
...
//            }).appendTo("body");
        ...
        var btn = $('<a href="javascript:void(null)" id="icp_' + _self.id + '" ><img src="' + imageUrl + '" style="border:0;margin:0 0 0 3px" align="absmiddle" ></a>');
        btn.click(function(e){
            e.stopPropagation();
            iColorShow(_self.id,'icp_'+_self.id);
        });
       jQuery(_self).css("backgroundColor", jQuery(_self).val()).after(btn);
    });
};
jQuery(function() {
    iColorPicker();
